...
const footerLinks = {
  ...
  venues: [
    { name: "Music City Center", href: "/venues/music-city-center" },
    { name: "Gaylord Opryland", href: "/venues/gaylord-opryland" },
      ...
      <div className="section-container py-12 lg:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-body-sm text-jhr-white-dim max-w-sm mb-6">
              Nashville's trusted partner for corporate event photography, headshot activations, and conference media coverage. Agency-grade execution. Zero friction.
            </p>
          ...
          {/* Services Links */}
          <div>
            <h3 className="text-heading-md font-semibold text-jhr-white mb-4">Services</h3>
          ...
          {/* Company Links */}
          <div>
            <h3 className="text-heading-md font-semibold text-jhr-white mb-4">Company</h3>
            <ul className="space-y-2">
        ...
        {/* Bottom Bar */}
        <div className="mt-12 pt-8 border-t border-jhr-black-lighter flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-body-sm text-jhr-white-dim">
            &copy; {new Date().getFullYear()} JHR Photography. All rights reserved.
          </p>
