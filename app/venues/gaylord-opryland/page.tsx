...
// ============================================================================
// Gaylord Opryland Venue Page - Editable with inline CMS
// ============================================================================

const VENUE_SLUG = "gaylord-opryland";
...
export default function GaylordOprylandPage() {
  ...
  useEffect(() => {
    loadSectionsForPage('gaylord-opryland', GAYLORD_OPRYLAND_SCHEMA.sections);
