...
// ============================================================================
// Music City Center Venue Page - Editable with inline CMS
// ============================================================================

const VENUE_SLUG = "music-city-center";
...
export default function MusicCityCenterPage() {
  ...
  useEffect(() => {
    loadSectionsForPage('music-city-center', MUSIC_CITY_CENTER_SCHEMA.sections);
